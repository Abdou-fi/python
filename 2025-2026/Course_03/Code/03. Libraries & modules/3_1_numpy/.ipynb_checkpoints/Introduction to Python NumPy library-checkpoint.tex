\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{Introduction to Python NumPy library}
...
\begin{document}
    ...
    This file is a Jupyter notebook converted to LaTeX using the nbconvert
tool. It contains explanation, code snippets and outputs related to
NumPy array manipulations. For any question or remark please email me at
\href{mailto:Abdesselam@filali.net}{\nolinkurl{Abdesselam@filali.net}}
or throught my github (https://github.com/Abdou-fi/python\_libraries).

    \section{Numpy Array Creation
Methods}\label{numpy-array-creation-methods}

    \subsection{Create a NumPy array from a python
list}\label{create-a-numpy-array-from-a-python-list}
...
Zeros}\label{create-a-numpy-array-of-zeros}
...
\end{tcolorbox}
    ...
    \subsection{Create an Identity Numpy
Array}\label{create-an-identity-numpy-array}
...
\end{tcolorbox}
    ...
    \subsection{Create an equally spaced Numpy Array with a specific
step}\label{create-an-equally-spaced-numpy-array-with-a-specific-step}
...
\end{tcolorbox}
    ...
    \subsection{Generate a random numpy
array}\label{generate-a-random-numpy-array}
...
Methods}\label{numpy-array-manipulation-methods}

    \subsection{Shape of the NumPy Array}\label{shape-of-the-numpy-array}

    We can get the shape of a NumPy array using the \texttt{shape}
attribute. For example, if we have a 2x3 array, we can get its shape
like this:
...
\end{tcolorbox}
    ...
    \subsection{Concatenate multiple NumPy arrays to form one NumPy
Array}\label{concatenate-multiple-numpy-arrays-to-form-one-numpy-array}
